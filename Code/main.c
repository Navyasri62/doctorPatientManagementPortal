...
donornode *donorhead=NULL;
recnode *rechead=NULL;
int main()
{
    ...
    {    
        ...
        main_again:
		    ...
		    if(query2=='1'){
			    ...
			    while(1){
				    system("clear");
				    printf("**************Organ Donation Section**************\n");
			    printf("1.View organ Donation List\n2.View Organ Request List\n");
			    char org;
			    scanf("%s",&org);
			    if(org=='1'){
				    system("clear");
				    viewDonProfile(donorhead);
			    }
			    else if(org=='2'){
				    system("clear");
				    viewRecProfile(rechead);
			    }
			    else{
				    exit(0);
			    }
		    ...
		    {
			    system("clear");
			    printf("*************************** Organ Donation Portal****************\n");
			    printf("\n");
			    printf("\n1.Register As Donor\n2.Register For Receiving Organ\n3.Go Back \n");
			    char reg1;
